export type VerticalKey = "waimai" | "store" | "hotel";
...
export type CompareTabKey = "base" | "price" | "risk" | "rule";
...
export type CandidateMetrics = Record<string, string>;
...
export type VerticalConfig = {
  ...
  compareSubTip: string;
  compareTabs: CompareTab[];
  compareTip: string;
  compareTitle: string;
  confirmRows: CompareField[];
  confirmTitle: string;
  detailTabs: string[];
  detailTitle: string;
...
export const verticalOrder: VerticalKey[] = ["waimai", "store", "hotel"];
...
export const flowOrder: ScreenKey[] = [
  "select",
  "pool",
  "compare",
  "risk",
...
export const initialSelectedByVertical: Record<VerticalKey, string[]> = {
  hotel: ["hotel-a", "hotel-b", "hotel-c"],
  store: ["store-a", "store-b", "store-c"],
  waimai: ["waimai-a", "waimai-b", "waimai-c"]
};

export const initialSearchByVertical: Record<VerticalKey, string> = {
  hotel: "",
  store: "",
  waimai: ""
};

export const initialSortByVertical: Record<VerticalKey, SortKey> = {
  hotel: "recommended",
  store: "recommended",
  waimai: "recommended"
};

export const initialCompareTabByVertical: Record<VerticalKey, CompareTabKey> = {
  hotel: "base",
  store: "base",
  waimai: "base"
};

export const prototypeData: Record<VerticalKey, VerticalConfig> = {
  waimai: {
    name: "外卖",
    icon: "外",
    homeTitle: "美团本地生活智能决策助手",
    homeDescription:
      "帮你快速比较配送速度、到手价、评价风险与踩雷成本，把纠结时间花在更值得的地方。",
    ...
    summaryTip:
      "如果赶时间，优先选 A；如果预算更敏感，优先看 B；如果更在意稳定性，A 仍然是更稳妥的选择。",
    confirmTitle: "确认选择",
    detailTitle: "商家详情页",
    ...
    candidates: [
      {
        ...
        details: {
          ...
          coupon: "¥13 满减券",
          notice:
            "下单前建议再次确认优惠是否叠加成功，高峰期个别单品库存更新会稍慢。",
          menu: [
            {
              cta: "购买",
              name: "招牌鸡胸牛油果碗",
      ...
      },
      {
        ...
        details: {
          ...
          coupon: "套餐立减",
          notice:
            "如果在午高峰下单，建议预留更充足的等待时间，避免影响后续安排。",
          menu: [
            {
              cta: "购买",
              name: "手作牛肉堡套餐",
  ...
  store: {
    ...
    homeTitle: "到店餐饮帮我比套餐",
    homeDescription:
      "比较套餐价格、可用时间、退改限制和评价口碑，帮你更快挑到适合的到店方案。",
    ...
    summaryTitle: "AI 决策总结",
    summaryTip:
      "如果你最在意性价比，可以先看 A；如果是多人聚餐，B 更合适；如果想降低踩雷风险，C 的体验更稳。",
    confirmTitle: "确认选择",
    detailTitle: "套餐详情页",
    primaryAction: "前往商家下单",
    ...
    candidates: [
      ...
      },
      {
        ...
        details: {
          ...
          coupon: "预约后使用",
          notice:
            "如果你希望临时就去吃，这个方案会略显麻烦，更适合提前定好时间。",
          menu: [
            {
              cta: "购买",
              name: "四人火锅套餐",
  ...
  hotel: {
    ...
    homeDescription:
      "对比位置、房型、退改规则、价格和评价风险，帮你把住宿选择从纠结变成有依据的判断。",
    ...
    summaryTitle: "AI 决策总结",
    summaryTip:
      "如果你在意综合稳定性，优先看 A；如果预算更紧，B 更有优势；如果是亲子出行，C 的适配度更高。",
    confirmTitle: "确认选择",
    detailTitle: "酒店详情页",
    ...
    candidates: [
      {
        ...
        details: {
          ...
          coupon: "查看全部房型",
          notice:
            "建议在价格合适时先锁房，尤其是周末或节假日前后，价格波动会更明显。",
          menu: [
            {
              cta: "预订",
              name: "江景大床房",
      ...
      },
      {
        ...
        details: {
          ...
          coupon: "查看全部房型",
          notice:
            "如果你的行程会频繁进城，这家酒店的通勤成本需要提前算进整体预算里。",
          menu: [
            {
              cta: "预订",
              name: "亲子家庭房",
